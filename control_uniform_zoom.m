function uD = control_uniform_zoom(region, W,Cgs,C_maxz, f, df, i, Jz_maxz,Jz_minz)
...
%--------------------------------------------------------------------------
                            ...
                            if q==2
                                uD = uD + (f(i)-f(j)) * dot(Jz_maxz(pt1), nvector);
                            else
                                uD = uD + (f(i)-f(j)) * dot(Jz_minz(pt1), nvector);
                            end
                        end
...
%--------------------------------------------------------------------------
                    ...
                    if q==2
                        uD = uD + f(i) * dot(Jz_maxz(pt1), nvector);
                    else
                        uD = uD + f(i) * dot(Jz_minz(pt1), nvector);
                    end
                end
    ...
    uD = uD + df * polyarea_nan(W{i}(1,:), W{i}(2,:));
end
