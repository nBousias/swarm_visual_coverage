function uHI = control_uniform_tilt(region, W, Cgs,C_maxz, f, df, i, Jz_maxz,Jz_minz)
...
%--------------------------------------------------------------------------
                            ...
                            if q==2
                                uHI = uHI + (f(i)-f(j)) * dot(Jz_maxz(pt1), nvector);
                            else
                                uHI = uHI + (f(i)-f(j)) * dot(Jz_minz(pt1), nvector);
                            end
...
%--------------------------------------------------------------------------
                    ...
                    if q==2
                        uHI = uHI + f(i) * dot(Jz_maxz(pt1), nvector);
                    else
                        uHI = uHI + f(i) * dot(Jz_minz(pt1), nvector);
                    end
                end
    ...
    uHI = uHI + df * polyarea_nan(W{i}(1,:), W{i}(2,:));
end
